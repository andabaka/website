...
<img src="img/umap.jpg" width="100%" style="display: block; margin: auto;" />
...
Za vizulizaciju konačnih rezultata segmentacije kupaca koristit će se algoritam UMAP (engl. *Uniform Manifold Approximation and Projection*). UMAP omugućuje prikaz višedimenzionalnih podataka[^3].
